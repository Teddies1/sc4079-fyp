...
instance_types_query = 'select vm.vmTypeId, count(vm.vmId) as taskcount, vm.starttime * 86400 as starttime, vm.endtime * 86400 as endtime, (max((vm.endtime - vm.starttime)) * 86400) as maxruntime, vmType.core, vmType.memory from vm, vmType where vm.vmTypeId = vmType.vmTypeId and endtime <= 14 and machineId = 16 group by vm.vmTypeId;'
...
instance_types_output = "../outputs/vmlist3.csv"
